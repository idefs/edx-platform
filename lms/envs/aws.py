...
# Mailchimp
MAILCHIMP_API_KEY = AUTH_TOKENS.get('MAILCHIMP_API_KEY', MAILCHIMP_API_KEY)
MAILCHIMP_NEWSLETTER_LIST_ID = ENV_TOKENS.get('MAILCHIMP_NEWSLETTER_LIST_ID', MAILCHIMP_NEWSLETTER_LIST_ID)
MAILCHIMP_USER_LIST_ID = ENV_TOKENS.get('MAILCHIMP_USER_LIST_ID', MAILCHIMP_USER_LIST_ID)
MAILCHIMP_USER_LIST_GROUP_LIST_ID = ENV_TOKENS.get('MAILCHIMP_USER_LIST_GROUP_LIST_ID', MAILCHIMP_USER_LIST_GROUP_LIST_ID)
