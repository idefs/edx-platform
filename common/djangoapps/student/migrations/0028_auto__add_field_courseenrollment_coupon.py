...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseEnrollment.coupon'
        db.add_column('student_courseenrollment', 'coupon',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['coupons.Coupon'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseEnrollment.coupon'
        db.delete_column('student_courseenrollment', 'coupon_id')
    ...
    models = {
        ...
        'student.courseenrollment': {
            ...
            'coupon': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['coupons.Coupon']", 'null': 'True'}),
